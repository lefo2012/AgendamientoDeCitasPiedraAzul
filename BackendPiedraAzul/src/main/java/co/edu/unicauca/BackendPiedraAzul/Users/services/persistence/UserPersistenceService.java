...
import co.edu.unicauca.BackendPiedraAzul.Users.persistence.repository.UserRepositoryJPA;
...
public class UserPersistenceService implements IUserPersistenceService {
    ...
    public User findByEmail(String email) {
        java.util.Optional<UserEntity> entityOpt = jpaRepository.findAll().stream()
